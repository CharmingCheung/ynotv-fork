...
const BOOLEAN_KEYS = new Set([
  ...
  'epgMetadataBadgeResolution', 'epgMetadataBadgeFps', 'epgMetadataBadgeFpsSuffix', 'epgMetadataBadgeFhdLabels', 'epgResolutionFilterEnabled', 'epgCatchupFilterEnabled', 'epgMetadataBadgeSound', 'epgMetadataBadgeBitrate', 'epgMetadataBadgeAudioBitrate',
  ...
  'jellyfinSimklScrobbleEnabled', 'jellyfinDebugLoggingEnabled',
...
const NUMBER_KEYS = new Set([
  ...
  'widgetScale', 'widgetBgOpacity', 'sportsScale', 'sportsBgOpacity',
  ...
  'epgTitleFontSize', 'epgBodyFontSize', 'epgProgramFontSize', 'uiScale',
  ...
  try {
    ...
    if (result.data && !isEmptyData(result.data)) {
      ...
      store.setState({
        ...
        widgetScale: data.widgetScale ?? 1,
        widgetBgOpacity: data.widgetBgOpacity ?? 0.55,
        sportsScale: data.sportsScale ?? 1,
        sportsBgOpacity: data.sportsBgOpacity ?? 0.7,
        ...
        epgProgramFontSize: data.epgProgramFontSize ?? useSettingsStore.getState().epgProgramFontSize,
        ...
        defaultCategory: data.defaultCategory ?? useSettingsStore.getState().defaultCategory,
        ...
        mpvQuality: data.mpvQuality ?? useSettingsStore.getState().mpvQuality,
        ...
        tmdbLanguage: data.tmdbLanguage ?? useSettingsStore.getState().tmdbLanguage,
        ...
        jellyfinDebugLoggingEnabled: data.jellyfinDebugLoggingEnabled ?? false,
        ...
        alwaysSortFavoritesAlphabetically: data.alwaysSortFavoritesAlphabetically ?? false,
        ...
        controllerRepeatDelayMs: data.controllerRepeatDelayMs ?? useSettingsStore.getState().controllerRepeatDelayMs,
        controllerRepeatIntervalMs: data.controllerRepeatIntervalMs ?? useSettingsStore.getState().controllerRepeatIntervalMs,
        controllerVisualizerLayout: data.controllerVisualizerLayout ?? useSettingsStore.getState().controllerVisualizerLayout,
        customGamepadProfiles: data.customGamepadProfiles ?? useSettingsStore.getState().customGamepadProfiles,
        ...
        epgCatchupFilterEnabled: data.epgCatchupFilterEnabled ?? false,
